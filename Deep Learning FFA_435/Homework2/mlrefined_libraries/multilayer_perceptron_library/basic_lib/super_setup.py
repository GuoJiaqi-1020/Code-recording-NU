...
class Setup:
    ...
    def fit(self, **kwargs):
        ...
        if algo == 'RMSprop':
            weight_history, train_cost_history, val_cost_history = super_optimizers.RMSprop(self.cost, self.w_init,
        ...
        if algo == 'curvature_normalized':
            ...
            weight_history, train_cost_history, val_cost_history = super_optimizers.curvature_normalized(self.cost,
                                                                                                         self.w_init,
                                                                                                         self.x_train,
                                                                                                         self.y_train,
                                                                                                         self.x_val,
