...
# List up to 5 employees who you rely on the most for help or advice at work.â€? 
...
igraph_options(vertex.size = 8, vertex.color = 'grey', # vertex.size changes the size of nodes; vertex.color changes the color of nodes
