...
def double_plot(func, num_samples, **kwargs):
    ...
    ax2.plot_surface(w1_vals, w2_vals, func_vals, alpha=0.1, color='w', rstride=25, cstride=25, linewidth=0.7,
                     edgecolor='k', zorder=2)

    ax4.plot_surface(w1_vals, w2_vals, func_vals, alpha=0.1, color='w', rstride=25, cstride=25, linewidth=0.7,
                     edgecolor='k', zorder=2)
